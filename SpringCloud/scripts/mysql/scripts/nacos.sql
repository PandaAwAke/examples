...
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (2, 'shared-log.yaml', 'DEFAULT_GROUP', 'logging:\r\n  level:\r\n    com.pandaawake: debug\r\n  pattern:\r\n    dateformat: HH:mm:ss:SSS\r\n  file:\r\n    path: \"logs/${spring.application.name}\"', '1cf7fbdf100d607f8c2a409a03b7056a', '2024-09-19 01:48:54', '2024-09-19 01:48:54', NULL, '172.18.0.1', '', '', '日志共享配置', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (3, 'shared-swagger.yaml', 'DEFAULT_GROUP', 'knife4j:\r\n  enable: true\r\n  setting:\r\n    language: zh_cn\r\n    ', '9e2bbe0eecc57bc7bef384e4c2acb264', '2024-09-19 01:50:24', '2024-09-19 01:50:24', NULL, '172.18.0.1', '', '', '共享 swagger 配置', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (4, 'shared-openfeign.yaml', 'DEFAULT_GROUP', 'spring:\r\n  cloud:\r\n    openfeign:\r\n      okhttp:\r\n        enabled: true\r\n        ', '2d3bbefef84d688f63e9bda502b96dfe', '2024-09-19 01:50:58', '2024-09-19 01:50:58', NULL, '172.18.0.1', '', '', '共享 OpenFeign 配置', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (5, 'shared-jdbc.yaml', 'DEFAULT_GROUP', 'spring:\r\n  datasource:\r\n    url: jdbc:mysql://${hm.db.host:localhost}:${hm.db.port:3306}/${hm.db.name}?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=Asia/Shanghai\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    username: root\r\n    password: ${hm.db.pw}\r\n\r\nmybatis-plus:\r\n  configuration:\r\n    default-enum-type-handler: com.baomidou.mybatisplus.core.handlers.MybatisEnumTypeHandler\r\n  global-config:\r\n    db-config:\r\n      update-strategy: not_null\r\n      id-type: auto', '39adb17d2ed0b267f5745f6da6ffde36', '2024-09-19 02:53:53', '2024-09-19 02:53:53', NULL, '172.18.0.1', '', '', 'JDBC 共享配置文件', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (6, 'shared-sentinel.yaml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    sentinel:\n      transport:\n        dashboard: localhost:9000\n      http-method-specify: true', '69356b256fa888f0c2b98cd892624d94', '2024-09-21 02:39:47', '2024-09-21 03:05:45', NULL, '172.18.0.1', '', '', 'Alibaba sentinel dashboard 共享配置', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (7, 'shared-seata.yaml', 'DEFAULT_GROUP', 'seata:\r\n  registry:\r\n    type: nacos\r\n    nacos:\r\n      application: seata-server\r\n      server-addr: localhost:8848\r\n      group: DEFAULT_GROUP  # Nacos 中的分组\r\n      namespace: \"\"\r\n      username: \"nacos\"\r\n      password: \"nacos\"\r\n  tx-service-group: my_tx_group\r\n  service:\r\n    vgroup-mapping:  # 事务组与TC集群映射关系\r\n      my_tx_group: default  # 微服务的集群名\r\n      ', 'e7ccf046e810bee2ccaf46822cb2e274', '2024-09-23 02:31:47', '2024-09-23 02:31:47', NULL, '172.18.0.1', '', '', 'seata client', NULL, NULL, 'yaml', NULL, '');
